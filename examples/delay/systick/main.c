 ...
 **
 ** History:
 **   - 2019-03-07  V1.0  MSc  SysTick delay example
 *****************************************************************************/
#define __MAIN_C__
/*****************************************************************************/
/* Include files                                                             */
...
/**
 *********************************************************************************
 ** \brief Get current ms ticks counter used with SysTick IRQ
 **  
 ** \return Return tick in ms
 **  
 ** \details Get current ms ticks counter used with SysTick IRQ
 **  
 *********************************************************************************
 */
__WEAK uint32_t millis()
{
    return u32Counter;
}
